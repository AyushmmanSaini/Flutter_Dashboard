...
class PieChartSchool extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PieChartSchoolState();
}

class PieChartSchoolState extends State {
  int touchedIndex;
  ...
  List<PieChartSectionData> showingSections() {
    final String g = new SchoolDb().getData('govt').toString();
    var g1 = double.parse(g);
    final String a = SchoolDb().getData('aided').toString();
    var a1 = double.parse(a);
    final String p = SchoolDb().getData('pvt').toString();
    var p1 = double.parse(p);
    final String o = SchoolDb().getData('oth').toString();
    var o1 = double.parse(o);

    double summ = g1 + a1 + p1 + o1;
    double g1p = (g1 / summ) * 100;
    print('HELLOOOOOOOOOOOO---------->' + (g1p.toString()));
    print('---------------------------------------');
