...
class PieChartTeacher extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PieChartTeacherState();
}

class PieChartTeacherState extends State {
  int touchedIndex;
  ...
  List<PieChartSectionData> showingSections() {
    final String g = TeacherDb().getData('govt').toString();
    var g1 = double.parse(g);
    final String a = TeacherDb().getData('aided').toString();
    var a1 = double.parse(a);
    final String p = TeacherDb().getData('pvt').toString();
    var p1 = double.parse(p);
    final String o = TeacherDb().getData('oth').toString();
