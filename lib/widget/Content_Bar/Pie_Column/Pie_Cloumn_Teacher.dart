...
import 'package:dashboard/widget/Charts/Pie_Charts/piechart_teacher.dart';
import 'package:flutter/material.dart';
//import 'dart:convert';

class PieColumnTeacher extends StatelessWidget {
  //final String title;
  //final num number;
  //const PieColumn(this.title, this.number);

  //PieClass fact = PieClass.fromJson(list[0]);
  final String schl = Database(2).getData().toString();
